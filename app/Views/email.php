       ...
       <?php endif; ?>
        <input type="hidden" name="user_id" id="user_id" value="<?= $user['id'] ?>">
            <div class="formbold-input-flex">
                ...
                <div>
                    <input type="email" name="recipient" id="recipient" placeholder="Recipient Email" class="formbold-form-input">
                </div>
            </div>
            <div>
                <input type="text" name="subject" id="subject" placeholder="Subject" class="formbold-form-input">
                <label for="subject" class="formbold-form-label"></label>
            </div>
            <div class="formbold-textarea">
                <textarea name="body" id="body" rows="6" placeholder="Write your message..." class="formbold-form-input"></textarea>
                <label for="body" class="formbold-form-label"></label>
            </div>
            <div class="formbold-input-file">
                ...
                <label for="upload" class="formbold-input-label">
                    ...
                    Attach files
                    <input type="file" name="attachments[]" id="upload" multiple>
                </label>
            </div>
...
<script>
    ...
    document.getElementById('upload').addEventListener('change', function(event) {
        ...
        files.forEach(file => {
            ...
            fileNameSpan.className = 'formbold-filename';
            ...
            fileDisplayArea.appendChild(fileNameSpan);
        });
